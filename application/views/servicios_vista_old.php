        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                $deviceType = ($this->detect->isMobile() ? ($this->detect->isTablet() ? 'tablet' : 'phone') : 'computer');
                     ...
                     ?>
                        <div class="col-md-4 thumb-label-item animated web-design isotope-item fadeInUp animatedVisi" style="padding-right: 0px ! important;">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <div class="row">
                                        <div class="col-xs-12 btn-group img-overlay thumb-label-item-img">
                                            <img src="<?php echo base_url()."utilitarios/img/cursos/".$det['img']; ?>" class="img-responsive center-block" title="<?php echo $det['curso'];?>"/>
                                            <div class="item-img-overlay">
                                            <?php if($deviceType=="computer") {?>
                                                <a title="Ver Syllabus" url="<?php echo $pdf; ?>" href="http://www.activeaxon.com/html/kanzi/new/media/portfolio8.jpg" class="portfolio-zoom fa fa-plus ver-pdf" curso="<?php echo $det['curso']; ?>"></a>
                                            <?php } else { ?> 
                                              <a title="Ver Syllabus"  href="<?php echo $pdf; ?>" class="portfolio-zoom fa fa-cloud-upload fa-1x" curso="<?php echo $det['curso']; ?>"></a>
                                            <?php } ?> 
                                                    <div class="item_img_overlay_content">
                                                    <h3 class="thumb-label-item-title">
                                                        <a title="<?php echo $det['curso'];?>" href="<?php echo $pdf; ?>"><i class="fa fa-cloud-upload fa-1x"></i>&nbsp;<?php echo $det['curso'];?> </a>
                                                    </h3>
                                                </div>
                                            </div>
                                        </div>
