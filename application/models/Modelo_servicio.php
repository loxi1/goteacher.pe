    ...
    */
    ...
    {   
        ...
        else    
        {
            ...
            $data = $this->db->get()->result_array(); //print_r($this->db->last_query());
    ...
    function get_one_servicio( $id_servicio = "" )
    {
        if($id_servicio === "") {}
        else
        {
            ...
            $this->db->select("id_servicio, nombre");
            $this->db->from('servicio');
            $this->db->where($where);
            $this->db->order_by('orden', 'ASC');
            $data = $this->db->get()->row_array();
        }
        return (isset($data) && is_array($data)) ? ($data) : (false);
    }
